Project Environment
For this project, you'll need to use Python, a vector database (ChromaDB or LanceDB) and a Large Language Model (OpenAI API GPT-3.5 is recommended). Follow the directions on the Get a Vocareum OpenAI API Key page to get your API key. Consider using LangChain, or GPT Function calling.

You can complete the project in the workspace below, or build the project locally.
